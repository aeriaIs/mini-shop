import { AboutCompanyIllustration } from "../../utils/images";
    ...
    <div className="2xl:container 2xl:mx-auto lg:py-16 lg:px-20 md:py-12 md:px-6 py-9 px-4 mt-20">
      <div className="flex flex-col lg:flex-row justify-between gap-8">
        <div className="w-full lg:w-5/12 flex flex-col justify-center">
          <h1 className="text-3xl lg:text-4xl font-bold leading-9 text-cyan-600 pb-4">About Us</h1>
        ...
        <div className="w-full lg:w-7/12">
          <img className="w-full h-full" src={AboutCompanyIllustration} alt="A group of People" />
        </div>
      </div>
    </div>
  );
