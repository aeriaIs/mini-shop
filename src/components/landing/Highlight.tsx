  ...
  return (
    <div className="2xl:container 2xl:mx-auto lg:px-20 md:py-12 md:px-6 py-9 px-4 mty24">
      <div className=" grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 lg:gap-8 gap-6 ">
        ...
        <div className="rounded-xl p-6 bg-cyan-800/50">
          ...
          <p className=" text-xl text-gray-300 font-semibold leading-5 mt-6">Safe Shopping</p>
          <p className=" font-normal text-base leading-6 text-gray-400 my-4">
            Our all outlets have industry-leading health precautions
          </p>
          <a className=" cursor-pointer text-base leading-4 font-medium text-cyan-600 border-b-2 border-gray-800 hover:text-gray-600 ">
            Learn More
          </a>
        </div>
        ...
        <div className="rounded-xl p-6 bg-cyan-800/50">
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M3 21H21" stroke="#0891b2" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
            <path
          ...
          <p className=" text-xl text-gray-300 font-semibold leading-5 mt-6">Personal Shopping</p>
          <p className=" font-normal text-base leading-6 text-gray-400 my-4">
        ...
        <div className="rounded-xl p-6 bg-cyan-800/50">
          ...
          <p className=" text-xl text-gray-300 font-semibold leading-5 mt-6">Free Shipping</p>
          <p className=" font-normal text-base leading-6 text-gray-400 my-4">
