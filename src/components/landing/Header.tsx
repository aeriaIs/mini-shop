      ...
      <nav className="2xl:container 2xl:mx-auto sm:py-6 sm:px-7 py-2 px-4">
        ...
        <div className="flex justify-between ">
          <div className="hidden sm:flex flex-row items-center space-x-6">
            ...
            <svg
              ...
              <path
                ...
                strokeLinejoin="round"
              />
              <path d="M6 9H2V21H6V9Z" stroke="#1f1f1f" strokeLinecap="round" strokeLinejoin="round" />
              <path
            ...
            <svg
              ...
              <path
                ...
                strokeLinejoin="round"
              />
              <path d="M17.5 6.5H17.51" stroke="#1f1f1f" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
          </div>
          ...
          <div className="hidden sm:flex flex-row space-x-4">
            <button className="rounded-md flex space-x-2 w-20 h-8 font-semibold text-base text-sky-800 bg-blue-900 focus:outline-none hover:bg-cyan-600 hover:text-black duration-150 justify-center items-center">
              Cart
            </button>
          </div>
          {/* Burger Icon */}
