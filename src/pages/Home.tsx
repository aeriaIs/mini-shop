...
function HomePage() {
  return (
    <main className="min-h-screen bg-gradient-to-tr from-black to-blue-800">
      <Navbar />
    </main>
  );
}
      ...
      <nav className="2xl:container 2xl:mx-auto sm:py-6 sm:px-7 py-5 px-4">
        ...
        <div className="flex justify-between ">
          <div className="hidden sm:flex flex-row items-center space-x-6">
            <svg
              className=" focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-200 cursor-pointer"
              width={24}
              height={24}
              viewBox="0 0 24 24"
              fill="none"
            ...
            <svg
              ...
              <path
                ...
                strokeLinejoin="round"
              />
              <path d="M6 9H2V21H6V9Z" stroke="#eeeeee" strokeLinecap="round" strokeLinejoin="round" />
              <path
            ...
            <svg
              ...
              <path
                ...
                strokeLinejoin="round"
              />
              <path d="M17.5 6.5H17.51" stroke="#eeeeee" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
          </div>
          <div className=" flex space-x-3 items-center">
            ...
            <h1 className=" font-bold tracking-wider text-2xl leading-6 text-gray-100">Mini Shop</h1>
          </div>
          <div className="hidden sm:flex flex-row space-x-4">
            <button className="rounded-md flex space-x-2 w-20 h-8 font-semibold text-base text-cyan-400 bg-blue-900 focus:outline-none hover:bg-cyan-600 hover:text-black duration-150 justify-center items-center">
              Cart
            </button>
          </div>
          {/* Burger Icon */}
          <div
            ...
            <svg
              ...
              <path
                ...
                strokeLinejoin="round"
              />
              <path d="M4 12H20" stroke="#eeeeee" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
              <path
                className=" transform duration-150"
                d="M4 18H20"
                stroke="#eeeeee"
            ...
            <svg
              ...
              fill="none"
              xmlns="http://www.w3.org/2000/svg">
              <path d="M18 6L6 18" stroke="#eeeeee" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
              <path d="M6 6L18 18" stroke="#eeeeee" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
          </div>
        </div>
